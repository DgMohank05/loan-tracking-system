...
<body>
    ...
    <section id="services" class="services-section">
        ...
        <div class="services-container">
            <div class="service-box">
                ...
                <button class="cta-button" onclick="window.location.href='/loan-tracking';">Go to Loan Tracking</button>
            </div>
            <div class="service-box">
                <h3>Payment Reminders</h3>
                <p>Get automatic notifications for upcoming payment due dates.</p>
                <button class="cta-button" onclick="window.location.href='/payment-reminders';">Go to Payment Reminders</button>
            </div>
            <div class="service-box">
                <h3>Interest Rate Management</h3>
                <p>Monitor your loan’s interest rates and manage adjustments.</p>
                <button class="cta-button" onclick="window.location.href='/interest-management';">Go to Interest Rate Management</button>
            </div>
        </div>
    </section>
    ...
    <script>
        // JavaScript to handle redirection to different pages
